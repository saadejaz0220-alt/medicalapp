...
class TwilioService {
  final String _accountSid = 'YOUR_TWILIO_ACCOUNT_SID'.trim();
  final String _authToken = 'YOUR_TWILIO_AUTH_TOKEN'.trim();
  final String _fromNumber = 'YOUR_TWILIO_PHONE_NUMBER'.trim();
